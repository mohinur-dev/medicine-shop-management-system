...
CREATE TABLE `customer` (
  ...
  `c_location` varchar(45) DEFAULT NULL,
  `c_contract` varchar(45) DEFAULT NULL,
  `c_credit_limit` double DEFAULT NULL,
  `c_credit` double DEFAULT NULL,
  `c_paid` double DEFAULT NULL,
...
INSERT INTO `customer` VALUES (1,'Shehabul Islam','Male','1975-04-11','Nimtala','0173423432432',10000,NULL,NULL,NULL,NULL);
